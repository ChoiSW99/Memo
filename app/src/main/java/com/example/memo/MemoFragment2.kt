...
class MemoFragment2 : Fragment() {
    ...
    var userList = arrayListOf<dataVo>(
        dataVo("22", "test1", "전주시", 30000000,"user_img_01"),
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? {
        var rootView = inflater.inflate(R.layout.fragment_memo2, container, false)

        recyclerView = rootView.findViewById(R.id.recyclerView2) as RecyclerView
